//! 한국어기초사전(krdict) 관련 코드입니다.
//! > [!NOTE]
//! > ‘한국어기초사전’은 한국어 학습자와 교사를 위한 한국어 학습용 웹 사전입니다. 또한, 한국어 교육 수요가 많은 지역의 언어로 번역하여 제공되는 ‘국립국어원 한국어-외국어 학습사전’의 기반이 되는 사전이기도 합니다.
//! > 한국어 학습자가 늘어나고, 한국어 교육의 역사가 길어지면서 다양한 학습자 특성과 교육 환경을 반영한 사전 편찬의 요구는 점차 높아져 왔습니다. 이러한 요구와 현실에 부응하고자 국립국어원에서는 2010년 ‘한국어기초사전’을 기획하였습니다. 그리고 2012년에는 한국어기초사전을 11개 언어*로 번역하는 ‘국립국어원 한국어-외국어 학습사전’ 편찬에 착수하였습니다.
//! > 새로운 언어를 배울 때 항상 옆에 두고 함께하는 것이 있다면, 그것은 바로 ‘사전’일 것입니다. 아무쪼록 이 사전이 한국어를 배우고 가르치는 분들에게 도움을 줄 수 있는 한국어 친구가 되기를 바랍니다.
use nutype::nutype;
